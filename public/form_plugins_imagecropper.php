...
$_title = 'Cropper - Form Plugins - SmartAdmin v4.6.3';
$_active_nav = 'form_plugins_imagecropper';
$_head = '	<!-- page related css -->
	<!-- FYI: it has a demo CSS file concatinated, about 1kb, you can remove it from build.js if needed -->
	<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/formplugins/cropperjs/cropper.css">

	<!-- page related demo css (for icons only) -->
	<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/fa-solid.css">
';
$_description = 'Cropper.js is a JavaScript library for cropping image';
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link mod-skin-<?= $_theme ?> ">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-credit-card-front'></i> Cropper<sup class='badge badge-primary fw-500'>ADDON</sup>
                                <small>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-9">
                                                        ...
                                                        <div class="img-container">
                                                            <img id="image" src="<?= ASSETS_URL ?>/img/demo/gallery/3.jpg" alt="Picture">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <!-- <h3>Preview:</h3> -->
        ...
        <script src="<?= ASSETS_URL ?>/js/formplugins/cropperjs/cropper.js"></script>
        <script>
            $(function()
            {
                'use strict';
