...
$_title = 'Cards - UI Components - SmartAdmin v4.6.3';
$_active_nav = 'ui_cards';
$_head = '';
$_description = 'Cards provide a flexible and extensible content container with multiple variants and options.';
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link mod-skin-<?= $_theme ?> ">
                            ...
                            <div class="d-flex flex-start w-100">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <p>Cards are built with as little markup and styles as possible, but still manage to deliver a ton of control and customization. Built with flexbox, they offer easy alignment and mix well with other Bootstrap components. They have no <code>margin</code> by default, so use spacing utilities as needed. Although cards are a lightweight solution for 'widget' or 'panel', we recommend you check out SmartAdmin's <a href="<?= APP_URL ?>/ui_panels.php" title="Components Panels" target="_blank">panels page</a> for further flexible and an alternative option.</p>
                                        <p class="mb-0">While we displayed some examples of cards here, you can learn more details of its usage at the official <a href="https://getbootstrap.com/docs/4.4/components/card/" target="_blank">bootstrap documentation</a>.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            ...
                                            <div class="card border m-auto m-lg-0" style="max-width: 18rem;">
                                                <img src="<?= ASSETS_URL ?>/img/card-backgrounds/cover-3-lg.png" class="card-img-top" alt="...">
                                                <div class="card-body">
                                ...
                                <div id="panel-5" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                                <code>.card-header</code>, <code>.card-body</code>, and <code>.card-footer</code> background cam be changed using <a href="<?= APP_URL ?>/utilities_color_pallet.php" target="_blank" title="BG Color Utility">color</a> and <a href="<?= APP_URL ?>/utilities_borders.php" target="_blank" title="border utilities">border</a> utilities
                                            </div>
                                            <!-- demo controls -->
                                            <div class="mb-g">
                                                <div class="row">
        ...
        <script>
            ...
            var ng_bgColors,
                ng_bgColors_URL = myapp_config.assetsUrl + "/media/data/ng-bg-colors.json",
                formatBgColors = [];
