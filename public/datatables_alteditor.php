...
$_title = 'AltEditor (beta) - Datatables - SmartAdmin v4.6.3';
$_active_nav = 'datatables_alteditor';
...
';
$_description = 'Custom made editor plugin designed for Datatables';
            ...
            $(document).ready(function()
            {
                ...
                */
                ...
                var myTable = $('#dt-basic-example').dataTable(
                {
                    ...
                    ajax: myapp_config.assetsUrl + "/media/data/server-demo.json",
                    columns: columnSet,
