...
$_title = 'Scrollspy - UI Components - SmartAdmin v4.6.3';
$_active_nav = 'ui_scrollspy';
$_head = '';
$_description = 'Automatically update Bootstrap navigation or list group components based on scroll position to indicate which link is currently active in the viewport.';
