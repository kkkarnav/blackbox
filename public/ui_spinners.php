...
$_title = 'Spinners - UI Components - SmartAdmin v4.6.3';
$_active_nav = 'ui_spinners';
$_head = '';
$_description = 'Indicate the loading state of a component or page with spinners, built entirely with HTML, CSS, and no JavaScript!';
                            ...
                            <div class="d-flex flex-start w-100">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <br>
                                        <br>
                                        Learn more about this plugin on bootstrap's <a href="https://getbootstrap.com/docs/4.4/components/spinners/" target="_blank">official documentation</a>.
                                    </div>
                                </div>
                            </div>
                        </div>
