...
$_title = 'Spacing - Utilities - SmartAdmin v4.6.3';
$_active_nav = 'utilities_spacing';
$_head = '<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/theme-demo.css">
';
$_description = 'Bootstrap includes a wide range of shorthand responsive margin and padding utility classes to modify an element’s appearance.';
                            ...
                            <div class="d-flex flex-start w-100">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <a href="https://getbootstrap.com/docs/4.4/utilities/spacing/" target="_blank">official documentation</a> also on this <a href="https://codepen.io/nextgenadmin/pen/VRExxJ" target="_blank">codepen example</a>
                                    </div>
                                </div>
                            </div>
                        </div>
