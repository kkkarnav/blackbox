...
$_title = 'Alert - PHP Components - SmartAdmin v4.6.3';
$_active_nav = 'php_controls_alert';
$_head = '';
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div id="panel-demo" class="panel">
                            <div class="panel-hdr">
                                <h2>\Bootstrap\Components\Alert</h2>
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <div class="frame-wrap bg-faded mb-5">
                                        <pre><code class="bg-fusion-400 d-block w-100 pt-2 pr-3 pb-2 pl-3 fw-700 js-output">$alert = new \Bootstrap\Components\Alert('Your transaction has been successfully processed! Thank you for your purchase :)', 'success');
$alert->class('m-0');
$alert->printHtml();</code></pre>
                                    </div>
                ...
                Enter additional information here
                                    ...
                                    <div class="markdown-body">
                                        ...
                                        $content = file_get_contents(DOCS_PATH.'/controls_alert.md');
