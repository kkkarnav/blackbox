...
$_title = 'Flot - Statistics - SmartAdmin v4.6.3';
$_active_nav = 'statistics_flot';
$_head = '';
$_description = 'Flot is a pure JavaScript plotting library for jQuery, with a focus on simple usage, attractive looks and interactive features';
