...
$_title = 'FA Pro Solid - ADMIN ONLY - SmartAdmin v4.6.3';
$_active_nav = 'icons_construct';
$_head = '<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/fa-light.css">
...
';
$_description = 'Font Awesome 5 Pro Icon test';
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link mod-skin-<?= $_theme ?> ">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item">ADMIN ONLY</li>
                            <li class="breadcrumb-item active">FA Pro Solid</li>
        ...
        <script>
            ...
            var filename = myapp_config.assetsUrl + "/media/data/fa-icon-list"; //available JSON files [ng-icon-base, ng-icon-list, ng-text-colors, fa-brand-list, fa-icon-list]
