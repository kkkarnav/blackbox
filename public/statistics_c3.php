...
$_title = 'C3 Charts - Statistics - SmartAdmin v4.6.3';
$_active_nav = 'statistics_c3';
$_head = '<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/statistics/c3/c3.css">
';
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link mod-skin-<?= $_theme ?> ">
                            ...
                            <div class="d-flex flex-start w-100">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <p class="m-0">
                                            Find more examples and guidelines on C3's <a href="https://c3js.org/examples.html" target="_blank">official documentation</a> and <a href="https://groups.google.com/forum/#!forum/c3js" target="_blank">community support</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="<?= ASSETS_URL ?>/js/statistics/d3/d3.js"></script>
        <!-- c3 charts : MIT license -->
        <script src="<?= ASSETS_URL ?>/js/statistics/c3/c3.js"></script>
        <script src="<?= ASSETS_URL ?>/js/statistics/demo-data/demo-c3.js"></script>
        <script>
