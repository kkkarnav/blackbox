...
$_title = 'Build Notes - Application Intel - SmartAdmin v4.6.3';
$_active_nav = 'intel_build_notes';
$_head = '';
$_description = 'Casing all release notes for your convenience';
                        ...
                        <div class="card mb-g">
                            <div class="card-body">
                                    ...
                                    <div class="d-flex flex-start w-100">
                                        ...
                                        <div class="d-flex flex-fill">
                                            <div class="flex-fill">
                                                ...
                                                nightly builds, bug fixes and feature requests. Please check the documentation for how to
                                                request access.
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <ul class="nav d-block fs-md pl-3">
                                    ...
                                    <li>
                                        <span class="badge badge-primary fw-n mr-1 width-3">SCRP</span> Removed Holder.js from packages and moved to CDN instead
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <span class="badge bg-success-700 fw-n mr-1 width-3">FICN</span> Updated Fontawesome Pro packages adding the all new <a href="<?= APP_URL ?>/icons_fontawesome_duotone.php" target="_blank">DuoTone icons</a> now with a total of 7500+ icons to choose from
                                    </li>
                                </ul>
                                <hr class="mt-4 mb-g">
                                <h4 class="mb-g">
                                ...
                                <ul class="nav d-block fs-md pl-3">
                                    ...
                                    <li>
                                        <span class="badge badge-primary fw-n mr-1 width-3">SCRP</span> Added _modules for SmartAdmin for PHP Core
                                    </li>
                                    <li>
