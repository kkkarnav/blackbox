...
$_title = 'Responsive Grid - Utilities - SmartAdmin v4.6.3';
$_active_nav = 'utilities_responsive_grid';
$_head = '';
$_description = 'Bootstrap includes a powerful mobile-first flexbox grid system for building layouts of all shapes and sizes.';
