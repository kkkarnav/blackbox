...
$_title = 'Select - PHP Components - SmartAdmin v4.6.3';
$_active_nav = 'php_controls_select';
$_head = '';
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div id="panel-demo" class="panel">
                            <div class="panel-hdr">
                                <h2>\Bootstrap\Components\Select</h2>
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <div class="frame-wrap bg-faded mb-5">
                                        <pre><code class="bg-fusion-400 d-block w-100 pt-2 pr-3 pb-2 pl-3 fw-700 js-output">$data = [
    ['id' => 1, 'name' => 'Lodev09', 'email' => 'lodev09@smartadmin.lodev09.com'],
    ['id' => 2, 'name' => 'foo', 'email' => 'bar@email.com'],
    ['id' => 3, 'name' => 'bar', 'email' => 'foo@email.com']
];
...
$select->printHtml();</code></pre>
                ...
                Enter additional information here
                                    ...
                                    <div class="markdown-body">
                                        ...
                                        $content = file_get_contents(DOCS_PATH.'/controls_select.md');
