...
$_title = 'Duotone - Font Icons - SmartAdmin v4.6.3';
$_active_nav = 'icons_fontawesome_duotone';
$_head = '<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/fa-duotone.css">';
$_description = 'Font Awesome 5 Pro Duotone';
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link mod-skin-<?= $_theme ?> ">
        ...
        <script>
            ...
            var filename = myapp_config.assetsUrl + "/media/data/fa-duotone"; //available JSON files [ng-icon-base, ng-icon-list, ng-text-colors, fa-brand-list, fa-icon-list, fa-icon-duotone]
