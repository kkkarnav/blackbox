...
$_title = 'Toastr - Notifications - SmartAdmin v4.6.3';
$_active_nav = 'notifications_toastr';
$_head = '<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/notifications/toastr/toastr.css">
<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/theme-demo.css">
';
$_description = 'Simple to use, lightweight notification plugin';
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-exclamation-circle'></i> Toastr <sup class='badge badge-primary fw-500'>ADDON</sup>
                                <small>
