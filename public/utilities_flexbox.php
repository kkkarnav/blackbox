...
$_title = 'Colors - Utilities - SmartAdmin v4.6.3';
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="alert alert-warning">
                                    ...
                                    <br>
                                    The flexbox behaviours are an adaptation from the core bootstrap 4 CSS system. To learn further about its responsive behaviours please head over to the <a href="https://getbootstrap.com/docs/4.4/utilities/flex/" target="_blank">official documentation for flexbox</a>.
                                </div>
                                <div class="card mb-g">
                                    <div class="card-body">
                                        <h4 class="mb-g">
