...
$_active_nav = 'icons_webfonts_faq';
$_head = '';
                        ...
                        <div class="alert alert-primary">
                            <div class="d-table w-100">
                                ...
                                <div class="d-table-cell align-middle pl-1">
                                    ...
                                    <br> Base Icons are primarily used as a 'base' layer for <strong>Stack Icons</strong>, but may also be used as regular general icons. To see base icons in action see the <a href="<?= APP_URL ?>/icons_stack_showcase.php" target="_blank">Stack Icons Showcase</a> page.
                                </div>
                            </div>
                        </div>
                        <div class="row">
