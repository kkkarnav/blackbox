...
$_title = 'Analytics Dashboard - Application Intel - SmartAdmin v4.6.3';
                                                ...
                                                <div class="bg-subtlelight-fade custom-scroll" style="height: 244px">
                                                    <div class="h-100">
                                                        ...
                                                        <div class="d-flex flex-row px-3 pt-3 pb-2">
                                                            <!-- profile photo : lazy loaded -->
                                                            <span class="status status-danger">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('<?= ASSETS_URL ?>/img/demo/avatars/avatar-admin.png')"></span>
                                                            </span>
                                                            <!-- profile photo end -->
                                                            <div class="ml-3">
