...
$_title = 'Export - Datatables - SmartAdmin v4.6.3';
$_active_nav = 'datatables_export';
...
';
$_description = 'Export datatables to PDF, Excel, and CSV formats - without any hassle!';
...
<html lang="en">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                                ...
                                                <p>
                                                    Since SmartAdmin for PHP is built for the "next generation" browsers, we removed the flash (.swf) alternative plugin due to security reasons and ActionScript's memory leakage
                                                </p>
                                            </div>
                                            <!-- datatable start -->
    ...
    NOTE:   The file size is pretty big, but you can always use the
        ...
        <script src="<?= ASSETS_URL ?>/js/datagrid/datatables/datatables.export.js"></script>
        <script>
