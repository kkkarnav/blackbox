...
$_title = 'Dropdowns - UI Components - SmartAdmin v4.6.3';
$_active_nav = 'ui_dropdowns';
$_head = '<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/theme-demo.css">
';
$_description = 'Toggle contextual overlays for displaying lists of links and more with the Bootstrap dropdown plugin.';
                            ...
                            <div class="d-flex flex-start w-100">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <br>
                                        <br>
                                        Find more facts and uses at the bootstrap <a href="https://getbootstrap.com/docs/4.4/components/dropdowns/" target="_blank">official documentation</a>.
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="panel-content">
                                            <div class="demo demo-no-mb">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu p-4 text-muted" style="max-width: 200px; background-image: url(<?= ASSETS_URL ?>/img/backgrounds/bg-4.png);">
                                                        <p>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-lg" style="background-image: url(<?= ASSETS_URL ?>/img/backgrounds/bg-1.png);">
