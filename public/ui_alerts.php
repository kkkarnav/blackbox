...
$_title = 'Alerts - UI Components - SmartAdmin v4.6.3';
$_active_nav = 'ui_alerts';
$_head = '<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/theme-demo.css">
';
$_description = 'Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages.';
