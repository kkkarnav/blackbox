...
$_title = 'Inbox - Page Views - SmartAdmin v4.6.3';
$_active_nav = 'page_inbox_general';
                                ...
                                <div class="position-absolute pos-top pos-bottom w-100">
                                    <div class="d-flex h-100 flex-column">
                                        ...
                                        <div class="flex-1 pr-3">
                                            <a href="<?= APP_URL ?>/page_inbox_general.php" class="dropdown-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md font-weight-bold d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0 active">
                                                <div>
                                            ...
                                            <ul id="js-emails" class="notification notification-layout-2">
                                                <li class="unread">
                                                    <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                                                        ...
                                                        <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                                            <div class="row w-100">
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">Melissa Ayre</a>
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">Re: New security codes (2)</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="unread">
                                                    <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                                                        ...
                                                        <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                                            <div class="row w-100">
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">Adison Le</a>
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">Welcome to the new portal, here is what you need to do</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                                                        ...
                                                        <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                                            <div class="row w-100">
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">Oliver Kopyuv</a>
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">Transformer Combustion Defuser is ready</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                                                        ...
                                                        <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                                            <div class="row w-100">
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">Dr. John Cook PhD</a>
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">PWS facts for patient #3245</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                                                        ...
                                                        <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                                            <div class="row w-100">
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">Sarah McBrook</a>
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">Are you coming to the after party?</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                                                        ...
                                                        <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                                            <div class="row w-100">
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">Lisa Hatchensen</a>
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">The results for bloodwork</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                                                        ...
                                                        <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                                            <div class="row w-100">
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">Anothony Bezyeth</a>
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">Questions regarding accesskey</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                                                        ...
                                                        <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                                            <div class="row w-100">
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">Wrapbootstrap</a>
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">Your registration is complete</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="unread">
                                                    <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                                                        ...
                                                        <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                                            <div class="row w-100">
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">Bloodworks Inc.</a>
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">Your results are here</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="unread">
                                                    <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                                                        ...
                                                        <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                                            <div class="row w-100">
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">Password reset</a>
                                                                <a href="<?= APP_URL ?>/page_inbox_read.php" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">Your password was changed</a>
                                                            </div>
                                                        </div>
