...
$_title = 'Popovers - UI Components - SmartAdmin v4.6.3';
$_active_nav = 'ui_popovers';
$_head = '';
$_description = 'Documentation and examples for adding Bootstrap popovers, like those found in iOS, to any element on your site.';
