...
$_title = 'Nouislider - Form Plugins - SmartAdmin v4.6.3';
$_active_nav = 'form_plugins_nouislider';
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-credit-card-front'></i> Nouislider<sup class='badge badge-primary fw-500'>ADDON</sup>
                                <small>
                                    blank description
                                </small>
                            </h1>
