...
$_title = 'Different Flavors - Package Info - SmartAdmin v4.6.3';
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <h1 class="fw-500 mb-5 mt-5 text-center">
                            SmartAdmin for PHP comes with multiple flavors
                                            ...
                                            <div class="card h-100 rounded overflow-hidden position-relative">
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <a href="https://wrapbootstrap.com/theme/smartadmin-asp.net-core-responsive-webapp-WB073L89G" class="btn btn-sm btn-outline-primary" target="_blank">Full Project – Sold Separately</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card h-100 rounded overflow-hidden">
                                                <div class="card-body p-4">
                                                    <div class="d-flex align-items-center mb-g">
                                                        ...
                                                        <h1 class="fw-300 m-0 l-h-n">
                                                            <span class="text-contrast">PHP</span>
                                                            <small class="fw-300 m-0 l-h-n">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <ul class="mt-3 list-spaced">
                                                            <li>
                                                                Clean and well documented code. Supports PHP 7.2 and later.
                                                            </li>
                                                            <li>
                                                        ...
                                                        <br>
                                                        <a href="https://wrapbootstrap.com/theme/smartadmin-php-responsive-webapp-WB05M9585" class="btn btn-sm btn-outline-primary" target="_blank">Full Project – Sold Separately</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 mb-4">
                                            ...
                                            <div class="card h-100 rounded overflow-hidden position-relative">
                                                <div class="card-body p-4">
                                                    <div class="d-flex align-items-center mb-g">
                                                        <img src="<?= ASSETS_URL ?>/img/demo/laravel.png" class="mr-3">
                                                        <h1 class="fw-300 m-0 l-h-n">
                                                            <span class="text-contrast">
                                                                Laravel 7
                                                            </span>
