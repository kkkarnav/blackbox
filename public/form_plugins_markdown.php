...
$_title = 'Markdown - Form Plugins - SmartAdmin v4.6.3';
$_active_nav = 'form_plugins_markdown';
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Markdown</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-credit-card-front'></i> Markdown<sup class='badge badge-primary fw-500'>ADDON</sup>
                                <small>
                                    blank description
                                </small>
                            </h1>
