...
$_title = 'General - Font Icons - SmartAdmin v4.6.3';
$_active_nav = 'icons_nextgen_general';
$_head = '';
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link mod-skin-<?= $_theme ?> ">
        ...
        <script>
            ...
            var filename = myapp_config.assetsUrl + "/media/data/ng-icon-list"; //available JSON files [ng-icon-base, ng-icon-list, ng-text-colors, fa-brand-list, fa-icon-list]
