...
$_title = 'Users - Database - SmartAdmin v4.6.3';
                                    ...
                                    <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                        <div class="d-flex flex-row align-items-center">
                                            <span class="status status-<?= \Common\Faker::random(['success', 'danger', 'warning']) ?> mr-3">
                                                <span class="rounded-circle profile-image d-block " style="background-image:url(<?= $user->getAvatarUrl(50) ?>); background-size: cover;"></span>
                                            </span>
