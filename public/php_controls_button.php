...
$_title = 'Button - PHP Components - SmartAdmin v4.6.3';
$_active_nav = 'php_controls_button';
$_head = '';
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div id="panel-demo" class="panel">
                            <div class="panel-hdr">
                                <h2>\Bootstrap\Components\Button</h2>
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <div class="frame-wrap bg-faded mb-5">
                                        <pre><code class="bg-fusion-400 d-block w-100 pt-2 pr-3 pb-2 pl-3 fw-700 js-output">$button = new \Bootstrap\Components\Button('Touch Me!');
$button->id('my-button')->type('input')->class('bg-success-50');
$button->printHtml();</code></pre>
                                    </div>
                ...
                Enter additional information here
                                    ...
                                    <div class="markdown-body">
                                        ...
                                        $content = file_get_contents(DOCS_PATH.'/controls_button.md');
