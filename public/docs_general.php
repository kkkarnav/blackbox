...
$_title = 'General Docs - Documentation - SmartAdmin v4.6.3';
$_active_nav = 'docs_general';
$_head = '';
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="card mb-g">
                            <div class="card-body">
                                ...
                                <p>All support questions related to HTML and/or CSS will be honored. Issues that are encountered on the Seed versions of specific flavors of SmartAdmin are covered by their <a href="<?= APP_URL ?>/intel_introduction.php" target="_blank">respective authors</a>, but will be limited to HTML and/or CSS issues. If you need assistance with a technical issue that is currently not covered by the FAQ, you will need to have purchased a Full license of that flavor and contact the respective author for further assistance. The Full version links will be added to the <a href="<?= APP_URL ?>/docs_flavors_editions.php" target="_blank">Flavors</a> page once they are made available.</p>
                            </div>
                        </div>
                    </main>
                    <!-- END Page Content -->
