...
$_title = 'Chartist.js - Statistics - SmartAdmin v4.6.3';
$_active_nav = 'statistics_chartist';
$_head = '<link rel="stylesheet" media="screen, print" href="'.ASSETS_URL.'/css/statistics/chartist/chartist.css">
';
$_description = 'Simple responsive charts';
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link mod-skin-<?= $_theme ?> ">
        ...
        <script src="<?= ASSETS_URL ?>/js/statistics/chartist/chartist.js"></script>
        <script>
            /* line chart area */
